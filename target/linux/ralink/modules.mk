...
define KernelPackage/sdhci-mt7620
  SUBMENU:=Other modules
  TITLE:=MT7620 SDCI
  DEPENDS:=@(TARGET_ralink_mt7620||TARGET_ralink_mt76x8||TARGET_ralink_mt7621) +kmod-mmc
  KCONFIG:= \
	CONFIG_MTK_MMC \
...
define KernelPackage/i2c-ralink
  ...
  DEPENDS:=+kmod-i2c-core @TARGET_ralink \
	@!(TARGET_ralink_mt7621||TARGET_ralink_mt76x8)
endef
...
define KernelPackage/hsdma-mtk
  ...
  DEPENDS:=@TARGET_ralink @TARGET_ralink_mt7621
  KCONFIG:= \
	CONFIG_DMADEVICES=y \
	CONFIG_DW_DMAC_PCI=n \
	CONFIG_MTK_HSDMA
...
define KernelPackage/sound-mt7620
  ...
  DEPENDS:=@TARGET_ralink @!TARGET_ralink_rt288x +kmod-dma-ralink \
...
define KernelPackage/mtk-hnat
  ...
  DEPENDS:=@TARGET_ralink @TARGET_ralink_mt7621 +kmod-nf-flow
  KCONFIG:= \
