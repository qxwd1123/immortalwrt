define KernelPackage/ata-ahci-mtk
  ...
  $(call AddDepends/ata)
  DEPENDS+=@(TARGET_mtk_mt7622||TARGET_mtk_mt7623)
endef
...
define KernelPackage/btmtkuart
  ...
  DEPENDS:=@TARGET_mtk_mt7622 +kmod-bluetooth +mt7622bt-firmware
...
define KernelPackage/sdhci-mtk
  ...
  DEPENDS:=@TARGET_mtk_mt7622 +kmod-sdhci
...
define KernelPackage/mediatek_hnat
  ...
  DEPENDS:=@TARGET_mtk +kmod-nf-conntrack
